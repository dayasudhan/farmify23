...
export default class Help extends Component {
  ...
  componentDidMount() {
    ReactGA.send({ hitType: "pageview", page: window.location.pathname,title: "Help APP Page" });
  }
    ...
    return (
      <Segment>
        ...
        <div style={{ padding: '1em' }}>
          ...
          <p>ನೀವು ನಿಮ್ಮ ಉಪಕರಣಗಳ ವಿವರಗಳನ್ನು ಸೇರಿಸಿದ ನಂತರ,  ನಮ್ಮ ಡೀಲರ್ ನಿಮ್ಮನ್ನು ಮುಂದಿನ ವ್ಯವಹಾರಕ್ಕಾಗಿ ಸಂಪರ್ಕಿಸುತಾರೆ</p>
          
          <h3>ಪ್ರಶ್ನೆ 6: ಡೀಲೆರ್ ಆಗಲು?</h3>
          <p>ನೀವು ಡೀಲೆರ್ ಆಗಲು ಅಥವಾ ಈಗಾಗಲೆ ನೀವು ಈ ವ್ಯವಹಾರದಲ್ಲಿ ಡೀಲರ್  ಆಗಿದ್ಧು ನಮ್ಮ ಟ್ರಾಕ್ಟರೀ ಅಪ್ ವ್ಯವಹಾರಕ್ಕಾಗಿ ಅಳವಡಿಸಿಕೊಳ್ಳಲು ಬಯಸಿಧಲ್ಲಿ ನಮ್ಮನ್ನು ಸಂಪರ್ಕಿಸಿ - ಫೋನ್ ನಂಬರ್ 9566229075</p>
          
          <h3>ಪ್ರಶ್ನೆ 7: 'ಟ್ರಾಕ್ಟ್ರೀ' ಆಪ್‌ನ ವೈಶಿಷ್ಟ್ಯಗಳೆನು?</h3>
          ...
          <h3>ಪ್ರಶ್ನೆ 8: 'ಟ್ರಾಕ್ಟ್ರೀ' ಆಪ್‌ನಲ್ಲಿ ವ್ಯಾಪಾರ ಮಾಡಲು ಶುಲ್ಕವೇನಾದರೂ ಇದೆ?</h3>
